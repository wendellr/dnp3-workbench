...
from app.models.client import CommMode
...
# New domain names. Keep client names for backward compatibility.
CreateMasterRequest = CreateClientRequest
UpdateMasterConfigRequest = UpdateClientConfigRequest
MasterResponse = ClientResponse
